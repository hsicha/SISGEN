                        ...
                        <div class="white_card card_height_100 mb_30">
                            <div class="white_card_header">
                                <div class="box_header m-0">
                                    <a href="<?=URL?>marca/ExportarExcelMarca" class="btn btn-success btn-sm"> <i class="fas fa-file-excel"></i> Exportar</a>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header ">
            <h5 class="modal-title " id="exampleModalLongTitle">Registro Marca</h5>
            <button
              type="button"
              class="close"
        ...
        <script src="<?php URL?>views/marca/js/marca.js"></script>
